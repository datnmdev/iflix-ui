...
export default function Header() {
  ...
  return (
    <>
      {isDisplayAuthBox ? <AuthBox setDisplayAuthBox={setDisplayAuthBox} /> : null}
          ...
          >
            ...
            >
              ...
              {profile ? (
                ...
                <button
                  className='border-solid border-2 border-red-500 rounded px-2 py-1
                  transition ease-in-out duration-500 hover:bg-red-500 
                  hover:text-white hover:shadow-2xl hover:shadow-red-500'
                  onClick={() => setDisplayAuthBox(!isDisplayAuthBox)}
                >
                  Đăng nhập
                </button>
              )}
